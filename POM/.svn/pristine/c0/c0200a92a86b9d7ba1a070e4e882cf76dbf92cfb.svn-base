...
public class PersonnelDAO {
	...
	public ArrayList<Personnel> getSearch(Connection conn, int search, String searchField) throws SQLException {
		...
		try {
			...
			String sql = "select * from personnel where " + colName + " like ?";
